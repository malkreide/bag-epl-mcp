"""BAG ePL MCP Server — Spezialitaetenliste, GGSL, MiGeL."""
...
try:
    ...
    # drift apart: pyproject said 1.0.1, this said 0.2.0. A value nobody
    # has to remember to bump cannot go stale.
    __version__ = _distribution_version("bag-epl-mcp")
